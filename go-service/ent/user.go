...
// was not loaded in eager-loading.
func (e UserEdges) MembershipsOrErr() ([]*ChannelMember, error) {
	if e.loadedTypes[1] {
...
// was not loaded in eager-loading.
func (e UserEdges) ChannelMessagesOrErr() ([]*ChannelMessage, error) {
	if e.loadedTypes[2] {
...
func (_m *User) QueryMemberships() *ChannelMemberQuery {
	return NewUserClient(_m.config).QueryMemberships(_m)
}

// QueryChannelMessages queries the "channel_messages" edge of the User entity.
func (_m *User) QueryChannelMessages() *ChannelMessageQuery {
	return NewUserClient(_m.config).QueryChannelMessages(_m)
}
