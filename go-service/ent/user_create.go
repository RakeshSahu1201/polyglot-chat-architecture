...
func (_c *UserCreate) AddOwnedChannelIDs(ids ...uuid.UUID) *UserCreate {
...
func (_c *UserCreate) AddMemberships(v ...*ChannelMember) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddChannelMessageIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddChannelMessageIDs(ids...)
	return _c
}

// AddChannelMessages adds the "channel_messages" edges to the ChannelMessage entity.
func (_c *UserCreate) AddChannelMessages(v ...*ChannelMessage) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
