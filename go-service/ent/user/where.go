...
func HasMembershipsWith(preds ...predicate.ChannelMember) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasChannelMessages() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasChannelMessagesWith(preds ...predicate.ChannelMessage) predicate.User {
	return predicate.User(func(s *sql.Selector) {
