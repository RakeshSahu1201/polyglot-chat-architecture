...
func (_q *ChannelQuery) QueryMemberships() *ChannelMemberQuery {
...
func (_q *ChannelQuery) WithMemberships(opts ...func(*ChannelMemberQuery)) *ChannelQuery {
	query := (&ChannelMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ChannelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Channel, error) {
	...
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *Channel) { n.Edges.Memberships = []*ChannelMember{} },
			func(n *Channel, e *ChannelMember) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *ChannelQuery) loadMemberships(ctx context.Context, query *ChannelMemberQuery, nodes []*Channel, init func(*Channel), assign func(*Channel, *ChannelMember)) error {
...
func (_q *ChannelQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withOwner != nil {
			_spec.Node.AddColumnOnce(channel.FieldOwnerID)
		}
	}
